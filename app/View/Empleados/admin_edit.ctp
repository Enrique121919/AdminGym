...
<br>
	<div class="col-sm-2 col-md-2 sidebar">
		<h3><?php echo __('Acciones'); ?></h3>
			...
			<ul>
				<?php echo $this->Html->link(__('Lista Empleados'), array('action' => 'index'),array('class'=>'list-group-item')); ?></l
			</ul>
			</div>
	</div>
...
<?php echo $this->Form->create('Empleado'); ?>
	...
	<?php
		...
		echo $this->Form->input('clave',array('type'=>'password', array ('class'=>'form-control')));
	?>
	</fieldset>
